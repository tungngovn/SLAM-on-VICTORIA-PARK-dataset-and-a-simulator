function g2orun(nSteps,pauseLen, makeVideo)
...
_vertex_rotation_threshold = pi/4;
...
## Manage cloud with trajectory waypoints

## Check if add a new vertex into the graph 
if (
